...
template <>
bool query_column<double, flsgpu::device::ALPColumn<double>>(const flsgpu::device::ALPColumn<double> column,
	...
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == enums::Unpacker::StatefulBranchless &&
		...
		return kernels::host::query_column<
		    ...
		    flsgpu::device::ALPColumn<double>>(column, magic_value, n_samples);
	}
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == enums::Unpacker::StatefulBranchless &&
