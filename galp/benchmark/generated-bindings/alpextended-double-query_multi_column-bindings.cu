...
template <>
bool query_multi_column<double, flsgpu::host::ALPExtendedColumn<double>>(
    const flsgpu::host::ALPExtendedColumn<double> column,
	...
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == enums::Unpacker::StatefulBranchless &&
		...
		return kernels::host::query_multi_column<
		    ...
		    flsgpu::host::ALPExtendedColumn<double>>(column, magic_value, n_samples);
	}
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == enums::Unpacker::StatefulBranchless &&
