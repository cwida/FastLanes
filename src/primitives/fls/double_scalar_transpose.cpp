...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// src/primitives/fls/double_scalar_transpose.cpp
// ────────────────────────────────────────────────────────
...
namespace generated { namespace transpose { namespace fallback { namespace scalar {
void transpose_i(const double* __restrict a_in_p, double* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
...
void transpose_o(const double* __restrict a_in_p, double* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[128]  = a_in_p[1];
	a_out_p[256]  = a_in_p[2];
	a_out_p[384]  = a_in_p[3];
