...
scheme_pool_t ExpPool<PT>::get_pool() {
	if constexpr (std::is_same_v<PT, i64_pt>) {
		...
		pool.emplace(28, Expression {static_cast<uint8_t>(DictFrqExp::var_t::UNCOMPRESSED), ExpT::DICT_FRQ});
		pool.emplace(29, Expression {static_cast<uint8_t>(DictFrqExp::var_t::FFOR_NO_PATCH), ExpT::DICT_FRQ});
		pool.emplace(30, Expression {static_cast<uint8_t>(DictFrqExp::var_t::FFOR_B_PATCH), ExpT::DICT_FRQ});
		pool.emplace(31, Expression {static_cast<uint8_t>(DictFrqExp::var_t::FFOR_S_PATCH), ExpT::DICT_FRQ});
		pool.emplace(32, Expression {static_cast<uint8_t>(DictFrqExp::var_t::FFOR_LL_PATCH), ExpT::DICT_FRQ});
		pool.emplace(33, Expression {static_cast<uint8_t>(DictFrqExp::var_t::FFOR_S_PATCH_REC), ExpT::DICT_FRQ});
		pool.emplace(34, Expression {static_cast<uint8_t>(DictFrqExp::var_t::DELTA_NO_PATCH), ExpT::DICT_FRQ});
		pool.emplace(35, Expression {static_cast<uint8_t>(DictFrqExp::var_t::DELTA_S_PATCH), ExpT::DICT_FRQ});
		pool.emplace(36, Expression {static_cast<uint8_t>(DictFrqExp::var_t::DELTA_LL_PATCH), ExpT::DICT_FRQ});
		pool.emplace(37, Expression {static_cast<uint8_t>(DictFrqExp::var_t::DELTA_B_PATCH), ExpT::DICT_FRQ});
		pool.emplace(38, Expression {static_cast<uint8_t>(DictFrqExp::var_t::DELTA_B_PATCH_REC), ExpT::DICT_FRQ});
		return pool;
	}
	/**/
...
Expression ExpPool<PT>::get_expression(const n_t expr_id) {
	...
	if (it == pool.end()) {
		throw std::runtime_error("exp does not  exist!");
	}
	return it->second;
}
