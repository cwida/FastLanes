...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// src/expression/analyze_operator_impl.hpp
// ────────────────────────────────────────────────────────
// Private implementation header for enc_analyze_opr template definitions.
// Included by analyze_operator.cpp and analyze_operator_unsigned.cpp
// to split instantiations across two TUs for parallel compilation.
// ────────────────────────────────────────────────────────
#ifndef FLS_EXPRESSION_ANALYZE_OPERATOR_IMPL_HPP
#define FLS_EXPRESSION_ANALYZE_OPERATOR_IMPL_HPP
...
#endif // FLS_EXPRESSION_ANALYZE_OPERATOR_IMPL_HPP
