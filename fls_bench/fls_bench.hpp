...
/*
 * The M1 cycle-counter is copied from repo: https://github.com/lemire/Code-used-on-Daniel-Lemire-s-blog/tree/master/2021/03/24
 */
#include <algorithm>
#include <array>
#include <bitset>
 ...
 * Now function has been added to be compatible with the rest of fls_bench.
 */
#if defined(__linux__)
namespace perf {
