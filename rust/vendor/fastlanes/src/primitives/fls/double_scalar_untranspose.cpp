...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// rust/vendor/fastlanes/src/primitives/fls/double_scalar_untranspose.cpp
// ────────────────────────────────────────────────────────
...
namespace generated { namespace untranspose { namespace fallback { namespace scalar {
void untranspose_i(const double* __restrict a_in_p, double* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
...
void untranspose_o(const double* __restrict a_in_p, double* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
