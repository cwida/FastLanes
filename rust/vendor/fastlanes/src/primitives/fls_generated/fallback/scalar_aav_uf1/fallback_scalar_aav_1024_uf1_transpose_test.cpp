...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// rust/vendor/fastlanes/src/primitives/fls_generated/fallback/scalar_aav_uf1/fallback_scalar_aav_1024_uf1_transpose_test.cpp
// ────────────────────────────────────────────────────────
// generated!
// NOLINTBEGIN
...
class fallback_scalar_aav_1024_uf1_transpose : public ::testing::Test {
public:
	uint8_t*  transposed8;
	...
	~fallback_scalar_aav_1024_uf1_transpose() override {
		delete[] transposed8;
		delete[] transposed16;
		delete[] transposed32;
		delete[] transposed64;
