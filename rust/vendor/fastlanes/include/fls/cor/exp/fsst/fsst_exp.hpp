...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// rust/vendor/fastlanes/include/fls/cor/exp/fsst/fsst_exp.hpp
// ────────────────────────────────────────────────────────
...
public:
	...
	inline constexpr static RPN FSST_CMPR = {2, //
	                                         2,
	                                         3,
	                                         true,
	...
	inline constexpr static RPN FSST_DECMPR = {2, //
	                                           2,
	                                           2,
	                                           true,
...
#endif // FLS_COR_EXP_FSST_FSST_EXP_HPP
