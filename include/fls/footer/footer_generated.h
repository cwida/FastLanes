...
inline const EntryPointType (&EnumValuesEntryPointType())[4] {
  static const EntryPointType values[] = {
    EntryPointType::UINT8,
    EntryPointType::UINT16,
    EntryPointType::UINT32,
    EntryPointType::UINT64
  };
  return values;
}
...
inline const char *EnumNameEntryPointType(EntryPointType e) {
  if (::flatbuffers::IsOutRange(e, EntryPointType::UINT8, EntryPointType::UINT64)) return "";
...
struct SegmentDescriptor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_ENTRYPOINT_OFFSET, 8) &&
           ...
           VerifyField<uint8_t>(verifier, VT_ENTRY_POINT_T, 1) &&
           verifier.EndTable();
  }
  ...
  static ::flatbuffers::Offset<SegmentDescriptor> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SegmentDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
inline ::flatbuffers::Offset<SegmentDescriptor> CreateSegmentDescriptor(
...
::flatbuffers::Offset<SegmentDescriptor> CreateSegmentDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const SegmentDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct BinaryValue FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  static ::flatbuffers::Offset<BinaryValue> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const BinaryValueT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
inline ::flatbuffers::Offset<BinaryValue> CreateBinaryValueDirect(
  ...
  return fastlanes::CreateBinaryValue(
      _fbb,
      binary_data__);
}

::flatbuffers::Offset<BinaryValue> CreateBinaryValue(::flatbuffers::FlatBufferBuilder &_fbb, const BinaryValueT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline void SegmentDescriptor::UnPackTo(SegmentDescriptorT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = entrypoint_offset(); _o->entrypoint_offset = _e; }
  { auto _e = entrypoint_size(); _o->entrypoint_size = _e; }
  { auto _e = data_offset(); _o->data_offset = _e; }
  { auto _e = data_size(); _o->data_size = _e; }
  { auto _e = entry_point_t(); _o->entry_point_t = _e; }
}

inline ::flatbuffers::Offset<SegmentDescriptor> SegmentDescriptor::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SegmentDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSegmentDescriptor(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<SegmentDescriptor> CreateSegmentDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const SegmentDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const SegmentDescriptorT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void BinaryValue::UnPackTo(BinaryValueT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = binary_data(); if (_e) { _o->binary_data.resize(_e->size()); std::copy(_e->begin(), _e->end(), _o->binary_data.begin()); } }
}

inline ::flatbuffers::Offset<BinaryValue> BinaryValue::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const BinaryValueT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateBinaryValue(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<BinaryValue> CreateBinaryValue(::flatbuffers::FlatBufferBuilder &_fbb, const BinaryValueT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const BinaryValueT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline bool VerifySegmentDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fastlanes::SegmentDescriptor>(nullptr);
}

inline bool VerifySizePrefixedSegmentDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fastlanes::SegmentDescriptor>(nullptr);
}

inline void FinishSegmentDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::SegmentDescriptor> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedSegmentDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::SegmentDescriptor> root) {
  fbb.FinishSizePrefixed(root);
}

inline std::unique_ptr<fastlanes::SegmentDescriptorT> UnPackSegmentDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<fastlanes::SegmentDescriptorT>(GetSegmentDescriptor(buf)->UnPack(res));
}

inline std::unique_ptr<fastlanes::SegmentDescriptorT> UnPackSizePrefixedSegmentDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
