...
struct RPN FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_OPERATOR_TOKENS) &&
           verifier.VerifyVector(operator_tokens()) &&
           VerifyOffset(verifier, VT_OPERAND_TOKENS) &&
           verifier.VerifyVector(operand_tokens()) &&
           verifier.EndTable();
  }
  ...
  static ::flatbuffers::Offset<RPN> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const RPNT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
inline ::flatbuffers::Offset<RPN> CreateRPN(
...
inline ::flatbuffers::Offset<RPN> CreateRPNDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return fastlanes::CreateRPN(
      _fbb,
      operator_tokens__,
      operand_tokens__);
}

::flatbuffers::Offset<RPN> CreateRPN(::flatbuffers::FlatBufferBuilder &_fbb, const RPNT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline void RPN::UnPackTo(RPNT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = operator_tokens(); if (_e) { _o->operator_tokens.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->operator_tokens[_i] = static_cast<fastlanes::OperatorToken>(_e->Get(_i)); } } else { _o->operator_tokens.resize(0); } }
  { auto _e = operand_tokens(); if (_e) { _o->operand_tokens.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->operand_tokens[_i] = _e->Get(_i); } } else { _o->operand_tokens.resize(0); } }
}

inline ::flatbuffers::Offset<RPN> RPN::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const RPNT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateRPN(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<RPN> CreateRPN(::flatbuffers::FlatBufferBuilder &_fbb, const RPNT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const RPNT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline bool VerifyRPNBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fastlanes::RPN>(nullptr);
}

inline bool VerifySizePrefixedRPNBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fastlanes::RPN>(nullptr);
}

inline void FinishRPNBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::RPN> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedRPNBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::RPN> root) {
  fbb.FinishSizePrefixed(root);
}

inline std::unique_ptr<fastlanes::RPNT> UnPackRPN(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<fastlanes::RPNT>(GetRPN(buf)->UnPack(res));
}

inline std::unique_ptr<fastlanes::RPNT> UnPackSizePrefixedRPN(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
