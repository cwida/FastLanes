...
struct DecimalType FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint64_t>(verifier, VT_SCALE, 8) &&
           verifier.EndTable();
  }
  ...
  static ::flatbuffers::Offset<DecimalType> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const DecimalTypeT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
::flatbuffers::Offset<DecimalType> CreateDecimalType(::flatbuffers::FlatBufferBuilder &_fbb, const DecimalTypeT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline ::flatbuffers::Offset<DecimalType> DecimalType::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const DecimalTypeT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateDecimalType(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<DecimalType> CreateDecimalType(::flatbuffers::FlatBufferBuilder &_fbb, const DecimalTypeT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const DecimalTypeT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _precision = _o->precision;
  auto _scale = _o->scale;
  return fastlanes::CreateDecimalType(
      _fbb,
      _precision,
      _scale);
}
