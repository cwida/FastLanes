...
struct RowgroupDescriptor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>> *m_column_descriptors() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>> *>(VT_M_COLUMN_DESCRIPTORS);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_M_N_VEC, 8) &&
           VerifyOffset(verifier, VT_M_COLUMN_DESCRIPTORS) &&
           verifier.VerifyVector(m_column_descriptors()) &&
           verifier.VerifyVectorOfTables(m_column_descriptors()) &&
           VerifyField<uint64_t>(verifier, VT_M_SIZE, 8) &&
           VerifyField<uint64_t>(verifier, VT_M_OFFSET, 8) &&
           VerifyField<uint64_t>(verifier, VT_M_N_TUPLES, 8) &&
           verifier.EndTable();
  }
  ...
  static ::flatbuffers::Offset<RowgroupDescriptor> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const RowgroupDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct RowgroupDescriptorBuilder {
  ...
  void add_m_column_descriptors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>>> m_column_descriptors) {
...
inline ::flatbuffers::Offset<RowgroupDescriptor> CreateRowgroupDescriptor(
    ...
    uint64_t m_n_vec = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>>> m_column_descriptors = 0,
    uint64_t m_size = 0,
    uint64_t m_offset = 0,
    uint64_t m_n_tuples = 0) {
...
inline ::flatbuffers::Offset<RowgroupDescriptor> CreateRowgroupDescriptorDirect(
    ...
    uint64_t m_offset = 0,
    uint64_t m_n_tuples = 0) {
  auto m_column_descriptors__ = m_column_descriptors ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>>(*m_column_descriptors) : 0;
  return fastlanes::CreateRowgroupDescriptor(
      _fbb,
      m_n_vec,
      m_column_descriptors__,
      m_size,
      m_offset,
      m_n_tuples);
}

::flatbuffers::Offset<RowgroupDescriptor> CreateRowgroupDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const RowgroupDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline RowgroupDescriptorT::RowgroupDescriptorT(const RowgroupDescriptorT &o)
  ...
  for (const auto &m_column_descriptors_ : o.m_column_descriptors) { m_column_descriptors.emplace_back((m_column_descriptors_) ? new fastlanes::ColumnDescriptorT(*m_column_descriptors_) : nullptr); }
}
...
inline void RowgroupDescriptor::UnPackTo(RowgroupDescriptorT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = m_n_vec(); _o->m_n_vec = _e; }
  { auto _e = m_column_descriptors(); if (_e) { _o->m_column_descriptors.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->m_column_descriptors[_i]) { _e->Get(_i)->UnPackTo(_o->m_column_descriptors[_i].get(), _resolver); } else { _o->m_column_descriptors[_i] = std::unique_ptr<fastlanes::ColumnDescriptorT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->m_column_descriptors.resize(0); } }
  { auto _e = m_size(); _o->m_size = _e; }
  { auto _e = m_offset(); _o->m_offset = _e; }
  { auto _e = m_n_tuples(); _o->m_n_tuples = _e; }
}

inline ::flatbuffers::Offset<RowgroupDescriptor> RowgroupDescriptor::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const RowgroupDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateRowgroupDescriptor(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<RowgroupDescriptor> CreateRowgroupDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const RowgroupDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const RowgroupDescriptorT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _m_n_vec = _o->m_n_vec;
  auto _m_column_descriptors = _o->m_column_descriptors.size() ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>> (_o->m_column_descriptors.size(), [](size_t i, _VectorArgs *__va) { return CreateColumnDescriptor(*__va->__fbb, __va->__o->m_column_descriptors[i].get(), __va->__rehasher); }, &_va ) : 0;
...
inline bool VerifyRowgroupDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fastlanes::RowgroupDescriptor>(nullptr);
}

inline bool VerifySizePrefixedRowgroupDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fastlanes::RowgroupDescriptor>(nullptr);
}

inline void FinishRowgroupDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::RowgroupDescriptor> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedRowgroupDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::RowgroupDescriptor> root) {
  fbb.FinishSizePrefixed(root);
}

inline std::unique_ptr<fastlanes::RowgroupDescriptorT> UnPackRowgroupDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<fastlanes::RowgroupDescriptorT>(GetRowgroupDescriptor(buf)->UnPack(res));
}

inline std::unique_ptr<fastlanes::RowgroupDescriptorT> UnPackSizePrefixedRowgroupDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
