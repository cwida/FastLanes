...
struct TableDescriptor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  /// A list of row‐group descriptors
  const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::RowgroupDescriptor>> *m_rowgroup_descriptors() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::RowgroupDescriptor>> *>(VT_M_ROWGROUP_DESCRIPTORS);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_M_ROWGROUP_DESCRIPTORS) &&
           verifier.VerifyVector(m_rowgroup_descriptors()) &&
           verifier.VerifyVectorOfTables(m_rowgroup_descriptors()) &&
           VerifyField<uint64_t>(verifier, VT_M_TABLE_BINARY_SIZE, 8) &&
           verifier.EndTable();
  }
  ...
  static ::flatbuffers::Offset<TableDescriptor> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const TableDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct TableDescriptorBuilder {
  ...
  void add_m_rowgroup_descriptors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::RowgroupDescriptor>>> m_rowgroup_descriptors) {
...
inline ::flatbuffers::Offset<TableDescriptor> CreateTableDescriptor(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::RowgroupDescriptor>>> m_rowgroup_descriptors = 0,
    uint64_t m_table_binary_size = 0) {
...
inline ::flatbuffers::Offset<TableDescriptor> CreateTableDescriptorDirect(
    ...
    uint64_t m_table_binary_size = 0) {
  auto m_rowgroup_descriptors__ = m_rowgroup_descriptors ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::RowgroupDescriptor>>(*m_rowgroup_descriptors) : 0;
  return fastlanes::CreateTableDescriptor(
      _fbb,
      m_rowgroup_descriptors__,
      m_table_binary_size);
}

::flatbuffers::Offset<TableDescriptor> CreateTableDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const TableDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline TableDescriptorT::TableDescriptorT(const TableDescriptorT &o)
  ...
  for (const auto &m_rowgroup_descriptors_ : o.m_rowgroup_descriptors) { m_rowgroup_descriptors.emplace_back((m_rowgroup_descriptors_) ? new fastlanes::RowgroupDescriptorT(*m_rowgroup_descriptors_) : nullptr); }
}
...
inline void TableDescriptor::UnPackTo(TableDescriptorT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = m_rowgroup_descriptors(); if (_e) { _o->m_rowgroup_descriptors.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->m_rowgroup_descriptors[_i]) { _e->Get(_i)->UnPackTo(_o->m_rowgroup_descriptors[_i].get(), _resolver); } else { _o->m_rowgroup_descriptors[_i] = std::unique_ptr<fastlanes::RowgroupDescriptorT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->m_rowgroup_descriptors.resize(0); } }
  { auto _e = m_table_binary_size(); _o->m_table_binary_size = _e; }
}

inline ::flatbuffers::Offset<TableDescriptor> TableDescriptor::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const TableDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateTableDescriptor(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<TableDescriptor> CreateTableDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const TableDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const TableDescriptorT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _m_rowgroup_descriptors = _o->m_rowgroup_descriptors.size() ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::RowgroupDescriptor>> (_o->m_rowgroup_descriptors.size(), [](size_t i, _VectorArgs *__va) { return CreateRowgroupDescriptor(*__va->__fbb, __va->__o->m_rowgroup_descriptors[i].get(), __va->__rehasher); }, &_va ) : 0;
  auto _m_table_binary_size = _o->m_table_binary_size;
  return fastlanes::CreateTableDescriptor(
      _fbb,
      _m_rowgroup_descriptors,
      _m_table_binary_size);
}
...
inline bool VerifyTableDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fastlanes::TableDescriptor>(nullptr);
}

inline bool VerifySizePrefixedTableDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fastlanes::TableDescriptor>(nullptr);
}

inline void FinishTableDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::TableDescriptor> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedTableDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::TableDescriptor> root) {
  fbb.FinishSizePrefixed(root);
}

inline std::unique_ptr<fastlanes::TableDescriptorT> UnPackTableDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<fastlanes::TableDescriptorT>(GetTableDescriptor(buf)->UnPack(res));
}

inline std::unique_ptr<fastlanes::TableDescriptorT> UnPackSizePrefixedTableDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
