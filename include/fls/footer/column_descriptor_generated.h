...
struct ExpressionResult FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint16_t>(verifier, VT_OPERATOR_TOKEN, 2) &&
  ...
  static ::flatbuffers::Offset<ExpressionResult> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ExpressionResultT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
inline ::flatbuffers::Offset<ExpressionResult> CreateExpressionResult(
...
::flatbuffers::Offset<ExpressionResult> CreateExpressionResult(::flatbuffers::FlatBufferBuilder &_fbb, const ExpressionResultT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct ColumnDescriptor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>> *children() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>> *>(VT_CHILDREN);
  }
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ExpressionResult>> *expr_space() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ExpressionResult>> *>(VT_EXPR_SPACE);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::SegmentDescriptor>> *segment_descriptors() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::SegmentDescriptor>> *>(VT_SEGMENT_DESCRIPTORS);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_ENCODING_RPN) &&
           verifier.VerifyTable(encoding_rpn()) &&
           ...
           VerifyOffset(verifier, VT_EXPR_SPACE) &&
           verifier.VerifyVector(expr_space()) &&
           verifier.VerifyVectorOfTables(expr_space()) &&
           VerifyOffset(verifier, VT_SEGMENT_DESCRIPTORS) &&
           verifier.VerifyVector(segment_descriptors()) &&
           verifier.VerifyVectorOfTables(segment_descriptors()) &&
           VerifyField<uint64_t>(verifier, VT_N_NULL, 8) &&
           VerifyOffset(verifier, VT_FIX_ME_DECIMAL_TYPE) &&
           verifier.VerifyTable(fix_me_decimal_type()) &&
           verifier.EndTable();
  }
  ...
  static ::flatbuffers::Offset<ColumnDescriptor> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ColumnDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct ColumnDescriptorBuilder {
  ...
  void add_children(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>>> children) {
  ...
  void add_expr_space(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::ExpressionResult>>> expr_space) {
    fbb_.AddOffset(ColumnDescriptor::VT_EXPR_SPACE, expr_space);
  }
  void add_segment_descriptors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::SegmentDescriptor>>> segment_descriptors) {
...
inline ::flatbuffers::Offset<ColumnDescriptor> CreateColumnDescriptor(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<fastlanes::SegmentDescriptor>>> segment_descriptors = 0,
    uint64_t n_null = 0,
...
inline ::flatbuffers::Offset<ColumnDescriptor> CreateColumnDescriptorDirect(
  ...
  auto expr_space__ = expr_space ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::ExpressionResult>>(*expr_space) : 0;
  auto segment_descriptors__ = segment_descriptors ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::SegmentDescriptor>>(*segment_descriptors) : 0;
  return fastlanes::CreateColumnDescriptor(
      _fbb,
      data_type,
      encoding_rpn,
      idx,
...
::flatbuffers::Offset<ColumnDescriptor> CreateColumnDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const ColumnDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline void ExpressionResult::UnPackTo(ExpressionResultT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = operator_token(); _o->operator_token = _e; }
  { auto _e = size(); _o->size = _e; }
}

inline ::flatbuffers::Offset<ExpressionResult> ExpressionResult::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ExpressionResultT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateExpressionResult(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<ExpressionResult> CreateExpressionResult(::flatbuffers::FlatBufferBuilder &_fbb, const ExpressionResultT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const ExpressionResultT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _operator_token = _o->operator_token;
  auto _size = _o->size;
  return fastlanes::CreateExpressionResult(
      _fbb,
      _operator_token,
      _size);
}
...
inline ColumnDescriptorT::ColumnDescriptorT(const ColumnDescriptorT &o)
  ...
  for (const auto &children_ : o.children) { children.emplace_back((children_) ? new fastlanes::ColumnDescriptorT(*children_) : nullptr); }
  expr_space.reserve(o.expr_space.size());
  for (const auto &expr_space_ : o.expr_space) { expr_space.emplace_back((expr_space_) ? new fastlanes::ExpressionResultT(*expr_space_) : nullptr); }
  segment_descriptors.reserve(o.segment_descriptors.size());
  for (const auto &segment_descriptors_ : o.segment_descriptors) { segment_descriptors.emplace_back((segment_descriptors_) ? new fastlanes::SegmentDescriptorT(*segment_descriptors_) : nullptr); }
}
...
inline void ColumnDescriptor::UnPackTo(ColumnDescriptorT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = data_type(); _o->data_type = _e; }
  { auto _e = encoding_rpn(); if (_e) { if(_o->encoding_rpn) { _e->UnPackTo(_o->encoding_rpn.get(), _resolver); } else { _o->encoding_rpn = std::unique_ptr<fastlanes::RPNT>(_e->UnPack(_resolver)); } } else if (_o->encoding_rpn) { _o->encoding_rpn.reset(); } }
  { auto _e = idx(); _o->idx = _e; }
  { auto _e = name(); if (_e) _o->name = _e->str(); }
  { auto _e = children(); if (_e) { _o->children.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->children[_i]) { _e->Get(_i)->UnPackTo(_o->children[_i].get(), _resolver); } else { _o->children[_i] = std::unique_ptr<fastlanes::ColumnDescriptorT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->children.resize(0); } }
  { auto _e = max(); if (_e) { if(_o->max) { _e->UnPackTo(_o->max.get(), _resolver); } else { _o->max = std::unique_ptr<fastlanes::BinaryValueT>(_e->UnPack(_resolver)); } } else if (_o->max) { _o->max.reset(); } }
  { auto _e = column_offset(); _o->column_offset = _e; }
  { auto _e = total_size(); _o->total_size = _e; }
  { auto _e = expr_space(); if (_e) { _o->expr_space.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->expr_space[_i]) { _e->Get(_i)->UnPackTo(_o->expr_space[_i].get(), _resolver); } else { _o->expr_space[_i] = std::unique_ptr<fastlanes::ExpressionResultT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->expr_space.resize(0); } }
  { auto _e = segment_descriptors(); if (_e) { _o->segment_descriptors.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->segment_descriptors[_i]) { _e->Get(_i)->UnPackTo(_o->segment_descriptors[_i].get(), _resolver); } else { _o->segment_descriptors[_i] = std::unique_ptr<fastlanes::SegmentDescriptorT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->segment_descriptors.resize(0); } }
  { auto _e = n_null(); _o->n_null = _e; }
  { auto _e = fix_me_decimal_type(); if (_e) { if(_o->fix_me_decimal_type) { _e->UnPackTo(_o->fix_me_decimal_type.get(), _resolver); } else { _o->fix_me_decimal_type = std::unique_ptr<fastlanes::DecimalTypeT>(_e->UnPack(_resolver)); } } else if (_o->fix_me_decimal_type) { _o->fix_me_decimal_type.reset(); } }
}

inline ::flatbuffers::Offset<ColumnDescriptor> ColumnDescriptor::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ColumnDescriptorT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateColumnDescriptor(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<ColumnDescriptor> CreateColumnDescriptor(::flatbuffers::FlatBufferBuilder &_fbb, const ColumnDescriptorT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const ColumnDescriptorT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _data_type = _o->data_type;
  auto _encoding_rpn = _o->encoding_rpn ? CreateRPN(_fbb, _o->encoding_rpn.get(), _rehasher) : 0;
  auto _idx = _o->idx;
  auto _name = _o->name.empty() ? 0 : _fbb.CreateString(_o->name);
  auto _children = _o->children.size() ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::ColumnDescriptor>> (_o->children.size(), [](size_t i, _VectorArgs *__va) { return CreateColumnDescriptor(*__va->__fbb, __va->__o->children[i].get(), __va->__rehasher); }, &_va ) : 0;
  ...
  auto _expr_space = _o->expr_space.size() ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::ExpressionResult>> (_o->expr_space.size(), [](size_t i, _VectorArgs *__va) { return CreateExpressionResult(*__va->__fbb, __va->__o->expr_space[i].get(), __va->__rehasher); }, &_va ) : 0;
  auto _segment_descriptors = _o->segment_descriptors.size() ? _fbb.CreateVector<::flatbuffers::Offset<fastlanes::SegmentDescriptor>> (_o->segment_descriptors.size(), [](size_t i, _VectorArgs *__va) { return CreateSegmentDescriptor(*__va->__fbb, __va->__o->segment_descriptors[i].get(), __va->__rehasher); }, &_va ) : 0;
  auto _n_null = _o->n_null;
  auto _fix_me_decimal_type = _o->fix_me_decimal_type ? CreateDecimalType(_fbb, _o->fix_me_decimal_type.get(), _rehasher) : 0;
  return fastlanes::CreateColumnDescriptor(
      _fbb,
      _data_type,
      _encoding_rpn,
...
inline bool VerifyColumnDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fastlanes::ColumnDescriptor>(nullptr);
}

inline bool VerifySizePrefixedColumnDescriptorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fastlanes::ColumnDescriptor>(nullptr);
}

inline void FinishColumnDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::ColumnDescriptor> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedColumnDescriptorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fastlanes::ColumnDescriptor> root) {
  fbb.FinishSizePrefixed(root);
}

inline std::unique_ptr<fastlanes::ColumnDescriptorT> UnPackColumnDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<fastlanes::ColumnDescriptorT>(GetColumnDescriptor(buf)->UnPack(res));
}

inline std::unique_ptr<fastlanes::ColumnDescriptorT> UnPackSizePrefixedColumnDescriptor(
    const void *buf,
    const ::flatbuffers::resolver_function_t *res = nullptr) {
