...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/arm64v8/neon_intrinsic_uf1/arm64v8_neon_intrinsic_1024_uf1_rsum_test.cpp
// ────────────────────────────────────────────────────────
...
class arm64v8_neon_intrinsic_1024_uf1_rsum: public ::testing::Test
{
	public:
	uint8_t *transposed8;
	...
	~arm64v8_neon_intrinsic_1024_uf1_rsum () override
	{
		delete[] transposed8;
		delete[] transposed16;
		delete[] transposed32;
...
;
TEST_F(arm64v8_neon_intrinsic_1024_uf1_rsum, test_0_ow_8_rsum)
{
	generated::rsum::arm64v8::neon::rsum(helper::delta_arr_ow8, transposed8, helper::base_arr_ow8);
...
TEST_F(arm64v8_neon_intrinsic_1024_uf1_rsum, test_1_ow_16_rsum)
{
	generated::rsum::arm64v8::neon::rsum(helper::delta_arr_ow16, transposed16, helper::base_arr_ow16);
	for (int i = 0; i < 1024; ++i)
	{
...
TEST_F(arm64v8_neon_intrinsic_1024_uf1_rsum, test_2_ow_32_rsum)
{
	generated::rsum::arm64v8::neon::rsum(helper::delta_arr_ow32, transposed32, helper::base_arr_ow32);
	for (int i = 0; i < 1024; ++i)
	{
...
TEST_F(arm64v8_neon_intrinsic_1024_uf1_rsum, test_3_ow_64_rsum)
{
	generated::rsum::arm64v8::neon::rsum(helper::delta_arr_ow64, transposed64, helper::base_arr_ow64);
	for (int i = 0; i < 1024; ++i)
	{
